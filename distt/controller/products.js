...
export const allAdminProducts = TryCatch(async (req, res, next) => {
    let products;
    let key = "all-products";
    if (myNode.has(key)) {
        products = JSON.parse(myNode.get(key));
    }
    else {
...
export const getSingleProduct = TryCatch(async (req, res, next) => {
    ...
    if (myNode.has(`product-${id}`)) {
        product = JSON.parse(myNode.get(`product-${id}`));
    }
    else {
...
export const getLatestProduct = TryCatch(async (req, res, next) => {
    ...
    if (myNode.has("latest-products")) {
        products = JSON.parse(myNode.get("all-products"));
    }
    else {
...
export const getAllCategories = TryCatch(async (req, res, next) => {
    ...
    if (myNode.has("categories")) {
        categories = JSON.parse(myNode.get("categories"));
    }
    else {
